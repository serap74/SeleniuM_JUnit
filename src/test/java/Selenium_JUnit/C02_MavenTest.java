...
public class C02_MavenTest {
    public static void main(String[] args) {
        ...
        WebElement signİn=driver.findElement(By.xpath("//button[@id='signin_button']"));
        signİn.click();
        ...
        if(sonucYazisiElementi.isDisplayed()){
            System.out.println("Sonuc yazisi elementi testi PASSED");
        }else{
            System.out.println("\"Sonuc yazisi elementi testi FAİLED");
